...
select name from country where population > 0 order by population asc limit 1;
select name from country where population > 0 order by population asc limit 1 offset 1;
